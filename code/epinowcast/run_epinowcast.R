...
show_plot <- TRUE
# forecast_dates <- seq(from = as.Date("2024-05-23"),
#                       to = as.Date("2024-05-23"),
#                       by = 7)
...
for(data_source in data_sources){
  ...
  for(disease in diseases){
    ...
    # get data:
    triangle <- read.csv(paste0("../../data/", data_source, "/", disease, "/reporting_triangle-",
                                data_source, "-", disease, "-preprocessed.csv"))
    ...
    for(i in seq_along(forecast_dates)){
      ...
      dir <- paste0("../../submissions/", data_source, "/", disease, "/KIT-epinowcast")
      dir.create(dir)
      file <- paste0(dir, "/", forecast_date, "-", data_source, "-", disease, "-KIT-epinowcast.csv")
